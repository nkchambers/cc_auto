                ...
                <div className="listWrapper">
                    <div className="listSearch">
                        ...
                        <div className="lsItem">
                            ...
                            <input placeholder={"Seattle, WA"} onChange={e => setDestination("Seattle, WA")} type="text" />
                        </div>
                        <div className="lsItem">
                    ...
                    <h1 className="seattleVehicleTitle">City | Seattle</h1>
                        { loading ? "loading" 
                        : <>
                            {data.map(item => (
