...
const SuvList = () => {
    ...
    const { data, loading, error, reFetch } = useFetch(`/vehicles?experience=${"SUV"}&city=${destination || "seattle" || "newYork"}&min=${min || 0}&max=${max || 500}`);
            ...
            <div className="listContainer">
                <div className="listWrapper">
                    ...
                    <div className="listResult">
                        <h1 className="suvVehicleTitle">Experience | SUV</h1>
                        { loading ? "loading" 
                        : <>
                            {data.map(item => (
