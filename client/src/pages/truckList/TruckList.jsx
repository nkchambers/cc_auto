...
const TruckSuvList = () => {
    ...
    const { data, loading, error, reFetch } = useFetch(`/vehicles?experience=${"Truck"}&city=${destination || "seattle" || "newYork"}&min=${min || 0}&max=${max || 299}`);
        ...
        <div>
            ...
            <div className="listContainer">
                <div className="listWrapper">
                    ...
                    <h1 className="truckSuvVehicleTitle">Experience | Truck</h1>
                        { loading ? "loading" 
                        : <>
                            {data.map(item => (
