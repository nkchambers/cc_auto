...
const VanList = () => {
    ...
    const { data, loading, error, reFetch } = useFetch(`/vehicles?experience=${"Van"}&city=${destination || "seattle" || "newYork"}&min=${min || 0}&max=${max || 299}`);
            ...
            <div className="listContainer">
                <div className="listWrapper">
                    ...
                    <div className="listResult">
                        <h1 className="vanVehicleTitle">Experience | Vans</h1>
                        { loading ? "loading" 
                        : <>
                            {data.map(item => (
